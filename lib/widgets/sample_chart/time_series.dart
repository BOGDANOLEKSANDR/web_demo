...
class TimeSeriesBar extends StatelessWidget {
  ...
  static List<charts.Series<TimeSeriesSales, DateTime>> _createSampleData() {
    final data = [
      new TimeSeriesSales(new DateTime(0, 0, 0, 6), 5),
      new TimeSeriesSales(new DateTime(0, 0, 0, 9), 15),
      new TimeSeriesSales(new DateTime(0, 0, 0, 10), 25),
      new TimeSeriesSales(new DateTime(0, 0, 0, 11), 15),
      new TimeSeriesSales(new DateTime(0, 0, 0, 12), 5),
      new TimeSeriesSales(new DateTime(0, 0, 0, 14), 35),
      // new TimeSeriesSales(new DateTime(2017, 9, 2), 15),
